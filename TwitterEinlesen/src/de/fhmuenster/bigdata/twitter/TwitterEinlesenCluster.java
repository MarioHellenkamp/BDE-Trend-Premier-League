...
public class TwitterEinlesenCluster {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    cb.setOAuthConsumerKey("aYzqO1aQSxbkyKjvtZZsyyPtu");
	    cb.setOAuthConsumerSecret("HJF9FxahzRWlvNaCCWBEk3S8Z9A8ZX1vNCDs4uRtOwhxATzmps");
	    cb.setOAuthAccessToken("3027879981-6lMFgrXK8nKQdlLmuya9N9nYJP5NSQVEyGRVDTu");
	    cb.setOAuthAccessTokenSecret("CzgKAk3LXAAtugaHgMPAHLI7IdMI2BE4ukURJB6SMPjPR ");
